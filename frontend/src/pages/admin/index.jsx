            ...
            <Heading title={'_admin'} />
            {
                adminStatus ?
                    ...
                    <div className="admin-login-page-container">
                        <input type='text' placeholder='Enter your name or email...' className='admin-info-input' onChange={(e) => handleUserInfo(e, 'username')} onKeyDown={(e) => { handleAdminStatusByKey(e) }} />
                        <input type='password' placeholder='Enter your password...' className='admin-info-input' onChange={(e) => handleUserInfo(e, 'userpwd')} onKeyDown={(e) => { handleAdminStatusByKey(e) }} />
